...
import '../../../repository/collection_company_form.dart';
import '../../../widgets/footer.dart';

class CollectionTableViewByCattle extends StatefulWidget {
  final int cattleId;
  final String cattleName;

  const CollectionTableViewByCattle({
    super.key,
  ...
  @override
  State<CollectionTableViewByCattle> createState() =>
      _CollectionTableViewByCattleState();
}

class _CollectionTableViewByCattleState
    extends State<CollectionTableViewByCattle> {
  bool isLoading = true;
  ...
  Future<void> _load() async {
    ...
    try {
      final data = await CollectionCattleRepository.getAllByCattle(
        widget.cattleId,
      );
      if (!mounted) return;
  ...
  Future<void> _onEdit(Collection collection) async {
    final result = await showDialog<bool>(
      context: context,
      barrierDismissible: false,
      builder:
  ...
  Future<void> _onDelete(int id) async {
    ...
    final confirm = await showDialog<bool>(
      ...
      builder:
          (_) => AlertDialog(
            ...
            content: const Text("¿Deseas eliminar esta recolección?"),
            actions: [
              TextButton(
    ...
    if (confirm == true) {
      final ok = await CollectionCattleRepository.deleteForCattle(id);
      if (!mounted) return;
